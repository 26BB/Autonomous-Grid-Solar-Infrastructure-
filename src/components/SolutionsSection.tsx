  ...
  return (
    <section id="solutions" className="px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto w-full mb-20 sm:mb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-[#161F30] border border-[#2A374F] p-6 sm:p-8 rounded-xl flex flex-col justify-between relative overflow-hidden group hover:border-[#00E5FF] transition-all">
          <div>
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="material-symbols-outlined text-[#00E5FF] text-[32px]">
                bolt
              </span>
            </div>
          ...
          <div className="flex flex-col gap-3">
            <div
              className="w-full h-48 sm:h-56 rounded-lg bg-cover bg-center border border-[#2A374F] relative overflow-hidden shadow-inner"
              style={{
            ...
            >
              ...
              <div className="absolute bottom-3 left-3 text-[11px] font-mono text-white bg-[#0B0F19]/85 px-2.5 py-1 rounded border border-[#2A374F]">
                Telemetry Feed: Feeder 14 Pole #82A Insulator Audit
              </div>
            </div>
        ...
        <div className="bg-[#161F30] border border-[#2A374F] p-6 sm:p-8 rounded-xl flex flex-col justify-between relative overflow-hidden group hover:border-[#F59E0B] transition-all">
          <div>
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="material-symbols-outlined text-[#F59E0B] text-[32px]">
                wb_sunny
              </span>
            </div>
            <h3 className="text-2xl font-headline font-bold text-white mb-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-t from-[#0B0F19]/80 via-transparent to-transparent"></div>
              <div className="absolute bottom-3 left-3 text-[11px] font-mono text-white bg-[#0B0F19]/85 px-2.5 py-1 rounded border border-[#2A374F]">
                Thermal Ingress: Greenfield Array 4B Hotspot Detected
              </div>
            </div>
